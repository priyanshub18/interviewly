...
export default function ActivitiesPage() {
  ...
  const userRole: "user" | "admin" = isInterviewer ? "admin" : "user";
    ...
    <div className={`mt-16 ${currenttheme2.bg} transition-colors duration-500`}>
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="relative flex flex-col items-center justify-center mb-12 mt-4">
          ...
          >
            Track all your job application activities and stay informed about
            updates.
          </motion.p>
        </div>
        ...
        >
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              variant={
                selectedFilter === "application_submitted"
                  ? "default"
                  : "outline"
              }
              size="sm"
              onClick={() => setSelectedFilter("application_submitted")}
              className={
                selectedFilter === "application_submitted"
                  ? currenttheme2.button.primary
                  : currenttheme2.button.secondary
            ...
            <Button
              variant={
                selectedFilter === "application_shortlisted"
                  ? "default"
                  : "outline"
              }
              size="sm"
              onClick={() => setSelectedFilter("application_shortlisted")}
              className={
                selectedFilter === "application_shortlisted"
                  ? currenttheme2.button.primary
                  : currenttheme2.button.secondary
            ...
            <Button
              variant={
                selectedFilter === "application_rejected"
                  ? "default"
                  : "outline"
              }
              size="sm"
              onClick={() => setSelectedFilter("application_rejected")}
              className={
                selectedFilter === "application_rejected"
                  ? currenttheme2.button.primary
                  : currenttheme2.button.secondary
            ...
            {filteredActivities?.map((activity, index) => (
              ...
              >
                <Card
                  ...
                  } ${!activity.isRead ? "ring-2 ring-blue-500/50" : ""}`}
                >
        ...
        {(!filteredActivities || filteredActivities.length === 0) && (
          ...
          >
            ...
            <p className={`mb-6 ${currenttheme2.text.secondary}`}>
              {selectedFilter === "all"
                ? "You don't have any activities yet. Start applying for jobs to see your activity feed!"
                : `No ${selectedFilter === "unread" ? "unread" : selectedFilter} activities found.`}
            </p>
            {selectedFilter === "all" && (
              <Link href="/jobs">
