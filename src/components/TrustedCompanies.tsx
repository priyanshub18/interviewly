    ...
    <section className="py-16 bg-gradient-to-br from-gray-100/70 to-white dark:from-gray-900 dark:to-gray-800 border-y border-gray-200 dark:border-gray-700 overflow-hidden" id="trusted-companies">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 via-indigo-500 to-indigo-500 text-transparent bg-clip-text">
  ...
  return (
    <motion.div
      className="min-w-[150px] px-4 py-4 rounded-xl bg-white/80 dark:bg-gray-900/60 
                 ...
                 group group-hover:border-gradient-to-r group-hover:from-indigo-500 group-hover:to-blue-500 
    ...
    >
      <div className="text-lg font-semibold text-gray-800 dark:text-white text-center">
        <span className="group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-500 group-group-hover:via-indigo-500 group-hover:to-pink-500 transition-all duration-300">
          {company}
        </span>
      </div>
    </motion.div>
